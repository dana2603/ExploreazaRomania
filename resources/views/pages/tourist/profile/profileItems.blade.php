<div class="row main-row">
    <div class="col-6 mt-5 offset-3">
        <form>
            ...
            @csrf
            <div class="mb-3">
                <label for="alias" class="form-label">Alias utilizator</label>
                <input type="text" class="form-control" id="alias" name="alias" placeholder="Alias utilizator" value="{{$user->alias}}">
                <div class="invalid-feedback" id="invalid-alias"></div>
            </div>
            <div class="mb-3">
